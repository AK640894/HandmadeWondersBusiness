...
const Button: React.FC<ButtonProps> = ({ children, variant = 'primary', isLoading = false, className = '', ...props }) => {
  ...
  const variantClasses = {
    primary: 'text-white bg-brand-terracotta hover:bg-opacity-90 focus:ring-brand-terracotta',
    secondary: 'text-brand-dark bg-white border-gray-300 hover:bg-gray-50 focus:ring-brand-sage',
  };
